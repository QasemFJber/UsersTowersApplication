...
import com.example.userstowersapplication.databinding.ActivityShowMaintenanceBinding;
    ...
    private void getCategoriesOfId() {
        ...
        categoriesController.getAllCategoriesOfCategorieId(id, new ShowListenirs() {
            ...
            public void onSuccess(List<ShowCategorie> list) {
                Toast.makeText(ShowMaintenance.this, "List size is : "+ list.size(), Toast.LENGTH_SHORT).show();
