...
import com.example.userstowersapplication.databinding.ActivityShowPurchasesBinding;
    ...
    private void getCategoriesOfId() {
        ...
        categoriesController.getAllCategoriesOfCategorieId(id, new ShowListenirs() {
            ...
            public void onSuccess(List<ShowCategorie> list) {
                Toast.makeText(ShowPurchases.this, "List size is : "+ list.size(), Toast.LENGTH_SHORT).show();
